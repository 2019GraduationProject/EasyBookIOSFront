...
class LocalDiscoverController: UITableViewController, UISearchBarDelegate {
    ...
    let localEventData: [Event] = [
        Event(name: "预答辩交流会", date: EventDate(monthAndDay: "05-21"), location: "南京大学软件学院院楼603", group: ["预约访谈app组"], clause: [Clause(startTime: "13:00", endTime: "14:00", maxAmount: 3, currentAmount: 0), Clause(startTime: "15:00", endTime: "16:00", maxAmount: 3, currentAmount: 0)]),
